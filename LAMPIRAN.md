...
$$
\text{traceability_mean}(\text{indicator}, p) =
...
$$
\bar{s}(\text{context_relevance}, \text{baseline}) = \frac{46.00}{50} = 0.9200
$$

Untuk `context_relevance` pada metadata:

$$
\bar{s}(\text{context_relevance}, \text{metadata}) = \frac{49.00}{50} = 0.9800
$$

Sehingga delta metrik tersebut adalah:

$$
\Delta(\text{context_relevance}) = 0.9800 - 0.9200 = 0.0600
$$
...
$$
\begin{aligned}
\bar{s}(\text{answer_relevance}, \text{baseline}) &= \frac{41.7709470526}{50} = 0.8354189411 \\[4pt]
\bar{s}(\text{answer_relevance}, \text{metadata}) &= \frac{42.7672762990}{50} = 0.8553455260 \\[4pt]
\Delta(\text{answer_relevance}) &= 0.8553455260 - 0.8354189411 = 0.0199265849
\end{aligned}
$$
...
$$
\Delta_3(\text{answer_relevance}) = 0.7994447183 - 0.8947299409 = -0.0952852226
$$
...
$$
\text{traceability_mean}(\text{page_match}, \text{metadata}) = \frac{48}{50} = 0.9600
$$
...
$$
\begin{aligned}
\text{traceability_mean}(\text{chapter_match}, \text{metadata}) &= \frac{50}{50} = 1.0000 \\[4pt]
\text{traceability_mean}(\text{section_match}, \text{metadata}) &= \frac{50}{50} = 1.0000 \\[4pt]
\text{traceability_mean}(\text{label_match}, \text{metadata}) &= \frac{50}{50} = 1.0000
\end{aligned}
$$
